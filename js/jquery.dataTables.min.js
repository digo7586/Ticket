...
(function (h) {
  ...
  function vb(a, b) {
    ...
    a._iRecordsDisplay = parseInt(f,300);
    d = 0;
  ...
  m.defaults = {
    ...
    oLanguage: {
      oAria: {
        ...
        sSortDescending: ": ativar para classificar a coluna em oredem decrescenteding",
      },
      oPaginate: {
        sFirst: "Primeira",
        sLast: "Última",
      ...
      sInfo: "Mostrando _END_ do _TOTAL_ entradas",
      sInfoEmpty: "",
      sInfoFiltered: "_MAX_ Linhas nesta pagina",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
