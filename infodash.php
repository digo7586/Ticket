...
$totalLidos = $link->query("SELECT COUNT(id) as qtd FROM `hd_tickets` WHERE admin_read = 1 and resolved = 0");
...
while ($chamadosfinalizados = mysqli_fetch_object($totalConcluido)) {
    ...
    $progressoConcluido = ($chamadosFim / $chamadosAbertos) * 100; // calcula a porcentagem de chamados em andamento
}
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-4  g-3">
      ...
      <!--   <div class="col">
            <div class="card">
                <div class="card-head">
                    <h2 class="card-title mb-4">0 <sub class="fs-6">min</sub></h2>
